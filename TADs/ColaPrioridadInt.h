...
// PRE: -
// POS: retorna una nueva cola de prioridad vacia acotada de tama�o cota
...
// PRE: -
// POS: retorna una copia de la cola de prioridad c sin compartir memoria (con el mismo tama�o)
